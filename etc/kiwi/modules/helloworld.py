...
# this variable will be read and used by kiwi to describe this module
...
def kiwi_main():
	...
	# most kiwi modules use argparse
	# most also use 'kiwi_description' as description and docstring as epilog
	parser = argparse.ArgumentParser(description=kiwi_description, epilog=kiwi_main.__doc__)
